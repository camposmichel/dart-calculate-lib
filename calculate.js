...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var calculate = new A.Calculate(),
        t1 = type$.int_Function_int_int;
      self.sum = A.allowInterop(calculate.get$sum(), t1);
      self.sub = A.allowInterop(calculate.get$sub(), t1);
      self.div = A.allowInterop(calculate.get$div(), t1);
      self.mul = A.allowInterop(calculate.get$mul(), t1);
    }
  },
  J = {
  ...
  A.Calculate.prototype = {
    ...
    div$2(a, b) {
      return B.JSInt_methods.$tdiv(A._asInt(a), A._asInt(b));
    },
    mul$2(a, b) {
      return A._asInt(a) * A._asInt(b);
    }
  ...
  (function installTearOffs() {
    ...
    var _;
    _instance_2_u(_ = A.Calculate.prototype, "get$sum", "sum$2", 0);
    _instance_2_u(_, "get$sub", "sub$2", 0);
    _instance_2_u(_, "get$div", "div$2", 0);
    _instance_2_u(_, "get$mul", "mul$2", 0);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A._Required, A.MapMixin, A.LinkedHashMapCell, A.Rti, A._FunctionParameters, A._UnmodifiableMapMixin, A.Null, A.StringBuffer, A.Calculate]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["int(int,int)", "~(String,@)", "@(@)", "@(@,String)", "@(String)", "~(Object?,Object?)", "~(Symbol0,@)"],
